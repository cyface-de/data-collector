 ...
 */
package de.cyface.collector.v6.handler

import de.cyface.api.DatabaseConstants
import de.cyface.api.PauseAndResumeStrategy
import de.cyface.api.v2.Authorizer
import de.cyface.api.v2.UserRetriever
                ...
                try {
                    ...
                    loadUsers.onSuccess { accessibleUsers: Set<User> ->
                        try {
                            ...
                            val matched = accessibleUsers.stream().filter { u: User ->
                                u.name == username
