...
image:https://img.shields.io/badge/mongo-4.0.6-purple.svg[link="https://mongodb.com/"]
...
2. Increase version numbers in `build.gradle`, `docker-compose.yml`, `src/main/resources/webroot/openapi.yml` and `src/main/resources/management/openapi.yml`.
