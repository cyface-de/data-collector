...
2. Increase version numbers in `build.gradle`, `docker-compose.yml`, `src/main/resources/webroot/api/openapi.yml` and `src/main/resources/webroot/management/openapi.yml` and CHANGELOG.md.
