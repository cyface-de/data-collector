...
public class MeasurementRetriever {
    ...
    public Future<MeasurementStream> loadMeasurements(final List<String> userNames, final MongoClient dataClient) {
     ...
     * @return a {@code Future} containing the {@link MeasurementStream} with the users' data if successful
     */
    public Future<MeasurementStream> loadMeasurements(final List<String> userNames, final MongoClient dataClient,
        ...
        final var initializedHandler = new Handler<MeasurementStream>() {
            @Override
            public void handle(final MeasurementStream output) {
        ...
        new MeasurementStream(bucketStream, strategy, promise::fail, initializedHandler);
